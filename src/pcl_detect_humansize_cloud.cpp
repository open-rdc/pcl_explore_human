...
ExtractHumansizeCloud::ExtractHumansizeCloud(ros::NodeHandle nh)
{
	...
	private_nh.param("max_horizontal_height",max_horizontal_height_,-0.5);
	...
	private_nh.param("intensity_threshold", intensity_threshold_, 600);
	private_nh.param("min_intensity_threshold", min_intensity_threshold_, 300);
	...
	private_nh.param("search_range", search_range_, 3.0);
	private_nh.param("save_file_path", save_file_path_, std::string("~/"));
	private_nh.param("min_target_width", min_target_width_, 0.1);
	private_nh.param("max_target_width", max_target_width_, 1.6);
	private_nh.param("min_target_depth", min_target_depth_, 0.1);
	private_nh.param("max_target_depth", max_target_depth_, 1.6);
	private_nh.param("min_target_height", min_target_height_, 0.1);
